...
# arrange plots
res <- marrangeGrob(list(Gene_len, Exon_len, Log_geneLen, Log_exonLen, Intron_len, Log_intLen, intron_support), nrow = 2, ncol = 2)
...
# PLot perc support, again , will include exon support that is likely to be zero (if only using rna-seq)
...
# arrange plots
res2 <- marrangeGrob(list(chroms_support_intron), nrow = 1, ncol = 1)
